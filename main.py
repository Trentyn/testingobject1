...
def get_single_song(bot, update):
    ...
    bot.send_message(chat_id=chat_id, text="Fetching... ⏳️")
    ...
    if sent == 0:
       bot.send_message(chat_id=chat_id, text="An error has occurred, invalid characters are present, or the song was not found")
